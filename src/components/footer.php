        ...
        <div class="max-w-screen-xl mx-auto grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div>
                ...
                <div class="flex flex-col items-start mt-5 space-y-2">
                    <a class="hover:font-semibold" href="#about">Chi siamo</a>
                    <a class="hover:font-semibold" href="#mission">Obiettivi</a>
                    <a class="hover:font-semibold" href="#features">Attività</a>
                    <a class="hover:font-semibold" href="#teams">Team</a>
                    <a class="hover:font-semibold" href="#contact">Contatti</a>
                </div>
            </div>
